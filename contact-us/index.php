...
<head>
  ...
  <title>Contact Us  | Nectorflare</title>
...
<nav class="navbar navbar-expand-lg bg-white shadow-sm py-2 fixed-top">
  ...
  <div class="contact-header">
    ...
    <p class="lead mt-3">Have questions or custom requests? Contact Beadcrumbs — we’re here to help!</p>
  </div>
    ...
    <div class="row text-center">
      <div class="col-md-4">
        <div class="info-box">
          ...
          <p>Visit us to explore our creations and connect in person!</p>
          <a href="https://www.google.com/maps/search/?api=1&query=Unit+No+8125,+8th+Floor+Gaur+City+Mall+Office+Space,+Sector4,+Greater+Noida+West,+U.P.+201318" target="_blank">
  Unit No 8125, 8th Floor Gaur City Mall Office Space, Sector4, Grater Noida West, U.P. 201318
</a>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="info-box">
          ...
          <h5 class="mt-3">E-mail Us</h5>
          <p>Email us anytime for quick responses, reliable support, and solutions.</p>
          <a href="mailto:info@nectorflare.com">info@nectorflare.com</a><br>
        </div>
      </div>
    </div>
    </div>
    ...
    <form>
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="fullName" placeholder="You Name">
        </div>
        <div class="col-md-6">
          <label for="email">E-mail</label>
          <input type="email" class="form-control" id="email" placeholder="You Name">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="inquiry" placeholder="Enquiry">
        </div>
      </div>

      <div class="mb-4">
        <label for="message">How We Can Help You ?</label>
        <textarea class="form-control" id="message" rows="5" placeholder="Let us Know What You need"></textarea>
      </div>
    ...
    <div class="footer-text">
        Connect with NectorFlare for quick support, trusted solutions, and personalized assistance. We’re here to help you every step forward. <br><br>
    </div>
  </div>
